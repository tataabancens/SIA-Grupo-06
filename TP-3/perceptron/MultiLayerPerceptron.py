...
import numpy as np
from trainer import Trainer, Batch, MiniBatch, Online
...
class MultiLayerPerceptron:
    ...
    def train(self, error_func: ErrorFunction, x_train, y_train,training_method: Trainer,epochs = 1000, learning_rate = 0.01, verbose = True):
...
def main():
    ...
    train_y = [[0],[1],[1],[0]]
    p.train(MeanSquared(), train_x, train_y, MiniBatch(2), 20000, 0.01, True)
    print(p.predict([1,1]))
